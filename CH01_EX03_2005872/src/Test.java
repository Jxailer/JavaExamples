...
public class Test {
	public static void main( String[] ar) {
		...
		//printf() : print format의 약자
		System.out.printf("이름은 김도현, 나이는 100, 몸무게는 10.3");
		System.out.printf("이름은 홍길동, 나이는 200, 몸무게는 22.5");
//		System.out.println("이름은" + "홍길동" + ", 나이는 "+" 200");
		System.out.printf("이름은 %s, 나이는 %d, 몸무게는 %f/n","김도현", 100, 10.3);
		System.out.printf("이름은 %s, 나이는 %d, 몸무게는 %f/n","홍길동", 200, 22.5);
